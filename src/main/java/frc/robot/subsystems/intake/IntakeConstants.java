...
public class IntakeConstants {
  ...
  public static final int DEPLOYMENT_MOTOR_CURRENT = 5;
  public static final int DEPLOYMENT_MOTOR_STOW_CURRENT = 6;
  public static final double DEPLOYMENT_MOTOR_REDUCTION = 5;
  public static final double DEPLOYMENT_MOTOR_CURRENT_LIMIT = 40;

  public static final int ROLLER_MOTOR_ID = 4;
  public static final int ROLLER_MOTOR_TORQUE = 16;
