...
public class AllianceFlipUtil {
  ...
  public static org.littletonrobotics.frc2026.util.geometry.Bounds apply(
      org.littletonrobotics.frc2026.util.geometry.Bounds bounds) {
    if (shouldFlip()) {
      return new org.littletonrobotics.frc2026.util.geometry.Bounds(
          applyX(bounds.maxX()),
          applyX(bounds.minX()),
          applyY(bounds.maxY()),
          applyY(bounds.minY()));
