package frc.robot;
/** Shameless copy of FRC 254's RobotState code from 2024 */
...
public class Localization {
  ...
  public Localization(Consumer<VisionFieldPoseEstimate> visionEstimateConsumer) {
  ...
  public Pose2d getLatestFieldToRobotCenter() {
    return fieldToRobot.getLatest().getValue();
  }
  ...
  /* TODO: Figure out passing strategy stuff
